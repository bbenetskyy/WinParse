...
namespace SiteAccess.Model.Bets
{
    ...
    {
        /// <summary>
        /// АПИ требует для того, чтобы 2 одинаковых запроса случайно не попали на сервер как 2 разных.
        /// Guid генерируется у себя, главное, чтобы следущий такой же отправился не раньше, чем через 30 мин, 
        /// иначе сгенерирует ошибку.
        /// </summary>
        public string Guid;
